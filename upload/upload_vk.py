...
def upload_to_vk(video_path, description="", title=""):
    ...
    try:
        ...
        # Prepare message
        message = description if description else "✨ Friends Forever!\n\n#friends #tvshow #90s #nostalgia #sitcom"
        ...
        video = upload.video(
            ...
            name=title or 'Friends Forever Video',
...
def main():
    ...
    description = sys.argv[2] if len(sys.argv) > 2 else "Best Friends Moment! ✨"
    title = sys.argv[3] if len(sys.argv) > 3 else "Friends Forever"
